...
TEST_F(ThumbCPUTest, LSL_Basic) {
    ...
    ASSERT_TRUE(assembleAndWriteThumb("lsls r0, r0, #2", cpu.R()[15]));
    execute(1);
...
TEST_F(ThumbCPUTest, LSL_CarryOut) {
    ...
    ASSERT_TRUE(assembleAndWriteThumb("lsls r1, r1, #1", cpu.R()[15]));
    execute(1);
...
TEST_F(ThumbCPUTest, LSL_ZeroResult) {
    ...
    ASSERT_TRUE(assembleAndWriteThumb("lsls r2, r2, #1", cpu.R()[15]));
    execute(1);
...
TEST_F(ThumbCPUTest, LSL_ShiftByZero) {
    ...
    ASSERT_TRUE(assembleAndWriteThumb("movs r3, r3", cpu.R()[15])); // LSL #0 is MOV in UAL
    execute(1);
...
TEST_F(ThumbCPUTest, LSL_MaxShift) {
    ...
    writeInstruction(cpu.R()[15], 0x07E4); // LSL R4, #31 (based on format01 original)
    execute(1);
...
TEST_F(ThumbCPUTest, LSR_Basic) {
    ...
    ASSERT_TRUE(assembleAndWriteThumb("lsrs r0, r0, #2", cpu.R()[15]));
    execute(1);
...
TEST_F(ThumbCPUTest, LSR_CarryOut) {
    ...
    ASSERT_TRUE(assembleAndWriteThumb("lsrs r1, r1, #1", cpu.R()[15]));
    execute(1);
...
TEST_F(ThumbCPUTest, LSR_ZeroResult) {
    ...
    ASSERT_TRUE(assembleAndWriteThumb("lsrs r2, r2, #1", cpu.R()[15]));
    execute(1);
...
TEST_F(ThumbCPUTest, LSR_ShiftByZero) {
    ...
    writeInstruction(cpu.R()[15], 0x081B); // LSR R3, #0 -> LSR R3, #32 (from format01 original)
    execute(1);
...
TEST_F(ThumbCPUTest, LSR_MaxShift) {
    ...
    writeInstruction(cpu.R()[15], 0x0FE4); // LSR R4, #31 (from format01 original)
    execute(1);
...
TEST_F(ThumbCPUTest, ASR_Basic) {
    ...
    ASSERT_TRUE(assembleAndWriteThumb("asrs r0, r0, #2", cpu.R()[15]));
    execute(1);
...
TEST_F(ThumbCPUTest, ASR_NegativeNumber) {
    ...
    ASSERT_TRUE(assembleAndWriteThumb("asrs r1, r1, #1", cpu.R()[15]));
    execute(1);
...
TEST_F(ThumbCPUTest, ASR_CarryOut) {
    ...
    ASSERT_TRUE(assembleAndWriteThumb("asrs r2, r2, #1", cpu.R()[15]));
    execute(1);
...
TEST_F(ThumbCPUTest, ASR_ShiftByZero) {
    ...
    writeInstruction(cpu.R()[15], 0x101B); // ASR R3, #0 -> ASR R3, #32 (from format01 original)
    execute(1);
...
TEST_F(ThumbCPUTest, ASR_MaxShift) {
    ...
    writeInstruction(cpu.R()[15], 0x17E4); // ASR R4, #31 (from format01 original)
    execute(1);
...
TEST_F(ThumbCPUTest, LSL_DifferentRegisters) {
    ...
    ASSERT_TRUE(assembleAndWriteThumb("lsls r4, r3, #1", cpu.R()[15]));
    execute(1);
