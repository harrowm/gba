...
const ARMCPU::arm_func_t ARMCPU::arm_further_decode[32 * 4] = {
    ...
    &ARMCPU::exec_arm_undefined, &ARMCPU::exec_arm_ldrh_reg_pre_nowb, &ARMCPU::exec_arm_ldrsb,     &ARMCPU::exec_arm_ldrsh, // -11---X- (exec_arm_undefined, LDRHP, LDRSBP, LDRSHP)
    ...
    &ARMCPU::exec_arm_undefined, &ARMCPU::exec_arm_ldrh_imm_pre_nowb, &ARMCPU::exec_arm_ldrsb,     &ARMCPU::exec_arm_ldrsh, // -1D---X- (SMLAL, LDRHIP, LDRBIP, LDRSHIPU)
