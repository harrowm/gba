...
def classify(bits_27_20, mul_swp_bit):
    ...
    if b27 == 1 or b26 == 1 or b25 == 1:
        mul_swp_bit = 0  # b27-b25 must be all zero for mul_swp_bit to be a 1
    ...
    # Single Data Transfer: b27=0, b26=1
    if b27 == 0 and b26 == 1:
        # b20 0 = STR, 1 = LDR
        # b22 0 = word, 1 = byte
        # b25 0 = imm, 1 = reg
        # b24 0 = post, 1 = pre
        # b21 0 = nowb, 1 = wb; POST index alwaysd WB as per ARM spec

        instr = "STR" if b20 == 0 else "LDR"
        if b22 == 1:
            instr += "B"
        ...
        if b21 == 0:
            ...
            instr += "_WB"
        # print(f"Single Data Transfer: {instr} b27={b27}, b26={b26}, b25={b25}, b24={b24}, b23={b23}, b22={b22}, b21={b21}, b20={b20}, mul_swp_bit={mul_swp_bit} instruction={bits_27_20:08X}")
        return instr
...
type_to_handler = {
    ...
    ,
    # Further decode handler
    "FurtherDecode": "exec_arm_further_decode"
}
